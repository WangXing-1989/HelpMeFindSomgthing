        ...
        this.sendPost("break-record",
            {
                ...
                secondTaskReaction: Model.instance.secondTaskReaction, //平均反应时
                thirdTaskSuccessCount: Model.instance.thirdTaskSuccessCount, //正确次数
                thirdTaskReaction: Model.instance.thirdTaskReaction, //平均反应时
                LevelDifficultyEnd: Model.instance.LevelDifficultyEnd, // 结束时所处难度水平
                date: this.userdate
